...
from app.api.v1.endpoints import (
    auth, users, projects, tasks, scan, members, config, database,
    prompts, rules, agent_tasks, embedding_config, ssh_keys,
    skills, mcp_servers, codecode,
)
...
api_router.include_router(codecode.router, prefix="/codecode", tags=["codecode"])
